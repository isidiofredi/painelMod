<h1 align="center">
  <img src="https://i.ibb.co/BKKXK0kw/ic-launcher.png" alt=" Foxnet DTunnel" style="width: 80px; height: 80px; border-radius: 50%;">
</h1>

<h4>Painel Exclusivo Para Foxnet Dtmod</h4>
...
```sh
sudo apt install wget -y; wget https://raw.githubusercontent.com/isidiofredi/painelMod/main/i.sh; chmod 777 i.sh; ./i.sh
```
...
```sh
git clone https://github.com/isidiofredi/painelMod.git
```
